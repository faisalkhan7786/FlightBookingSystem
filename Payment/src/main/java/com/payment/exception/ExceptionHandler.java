...
/*
 * package com.example.PaymentService.exception; import java.util.Date;
 * 
 ...
 * 
 * @ControllerAdvice public class ExceptionHandler { //handle specific exception
 * 
 * @org.springframework.web.bind.annotation.ExceptionHandler(
 * ResourceNotFoundException.class) public ResponseEntity<?>
 ...
 * 
 * @org.springframework.web.bind.annotation.ExceptionHandler(
 * MethodArgumentNotValidException.class) public ResponseEntity<?>
 * customValidation(MethodArgumentNotValidException exception) { ErrorDetails
